...
$('.voltar').addEventListener('click', () => {
    mostrarBotaoIMC();
    clearInputUrlNumberText('altura');
    clearInputUrlNumberText('peso');
...
function clearInputUrlNumberText(name) {
    var campos = document.querySelectorAll("input[name='"+name+"']");
    [].map.call(campos, altura => altura.value = '');
    [].map.call(campos, peso => peso.value = '');
  }
